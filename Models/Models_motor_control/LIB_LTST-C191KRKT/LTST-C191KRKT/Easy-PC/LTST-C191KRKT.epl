...
(library Library_1
	...
	(symbolDef "LTST-C191KRKT" (originalName "LTST-C191KRKT")
	...
	(compDef "LTST-C191KRKT" (originalName "LTST-C191KRKT") (compHeader (numPins 2) (numParts 1) (refDesPrefix LED)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LTST-C191KRKT"))
		...
		(attr "Manufacturer_Part_Number" "LTST-C191KRKT")
		(attr "Mouser Part Number" "859-LTST-C191KRKT")
		(attr "Mouser Price/Stock" "https://www.mouser.com/Search/Refine.aspx?Keyword=859-LTST-C191KRKT")
		(attr "RS Part Number" "1278415P")
		(attr "RS Price/Stock" "http://uk.rs-online.com/web/p/products/1278415P")
		(attr "Description" "Standard LEDs - SMD Red Clear 631nm")
		(attr "Datasheet Link" "http://www.mouser.com/ds/2/239/S_110_LTST-C191KRKT-539838.pdf")
		(attr "Height" "0.55 mm")
	)
