...
(library Library_1
	...
	(symbolDef "LTST-C191KGKT" (originalName "LTST-C191KGKT")
	...
	(compDef "LTST-C191KGKT" (originalName "LTST-C191KGKT") (compHeader (numPins 2) (numParts 1) (refDesPrefix LED)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LTST-C191KGKT"))
		...
		(attr "Manufacturer_Part_Number" "LTST-C191KGKT")
		(attr "Mouser Part Number" "859-LTST-C191KGKT")
		(attr "Mouser Price/Stock" "https://www.mouser.com/Search/Refine.aspx?Keyword=859-LTST-C191KGKT")
		(attr "RS Part Number" "6921010P")
		(attr "RS Price/Stock" "http://uk.rs-online.com/web/p/products/6921010P")
		(attr "Description" "LED,SMD,0603,Green,35mcd,130deg Lite-On LTST-C191KGKT Green LED, 571 nm 1608 (0603), Rectangle Lens SMD package")
		(attr "Datasheet Link" "http://www.mouser.com/ds/2/239/S_110_LTST-C191KGKT-369560.pdf")
		(attr "Height" "0.55 mm")
	)
