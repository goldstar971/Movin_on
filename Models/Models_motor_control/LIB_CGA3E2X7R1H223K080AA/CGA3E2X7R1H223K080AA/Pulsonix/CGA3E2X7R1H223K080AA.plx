...
//933648/124476/2.43/2/5/Capacitor
...
(library Library_1
	...
	(symbolDef "CGA3E2X7R1H223K080AA" (originalName "CGA3E2X7R1H223K080AA")
	...
	(compDef "CGA3E2X7R1H223K080AA" (originalName "CGA3E2X7R1H223K080AA") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "CGA3E2X7R1H223K080AA"))
		...
		(attr "Manufacturer_Part_Number" "CGA3E2X7R1H223K080AA")
		(attr "Mouser Part Number" "810-CGA3E2X7R1H223K")
		(attr "Mouser Price/Stock" "https://www.mouser.com/Search/Refine.aspx?Keyword=810-CGA3E2X7R1H223K")
		(attr "RS Part Number" "1447372")
		(attr "RS Price/Stock" "http://uk.rs-online.com/web/p/products/1447372")
		(attr "Description" "TDK 22nF Multilayer Ceramic Capacitor MLCC 50 V dc +/-10% X7R Dielectric 1608 Solder Max. Op. Temp. +125C")
		(attr "<Hyperlink>" "http://docs-emea.rs-online.com/webdocs/14e9/0900766b814e9125.pdf")
		(attr "<Component Height>" "0.9")
		(attr "<STEP Filename>" "CGA3E2X7R1H223K080AA.stp")
