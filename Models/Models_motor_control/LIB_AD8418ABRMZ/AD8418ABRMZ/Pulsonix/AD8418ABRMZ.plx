...
(library Library_1
	...
	(compDef "AD8418ABRMZ" (originalName "AD8418ABRMZ") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "3" (pinName "VREF2") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "4" (pinName "NC") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "8" (pinName "+IN") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "7" (pinName "VREF1") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "6" (pinName "VS") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "5" (pinName "OUT") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Output))
		...
		(attr "<Hyperlink>" "http://www.analog.com/media/en/technical-documentation/data-sheets/AD8418A.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "AD8418ABRMZ.stp")
