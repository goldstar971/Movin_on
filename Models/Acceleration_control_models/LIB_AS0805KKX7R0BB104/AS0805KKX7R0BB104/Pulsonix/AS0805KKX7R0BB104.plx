...
//1562503/124476/2.43/2/3/Capacitor

(asciiHeader
	(fileUnits MM)
)
(library Library_1
	(padStyleDef "r147_110"
		(holeDiam 0)
		(padShape (layerNumRef 1) (padShapeType Rect)  (shapeWidth 1.1) (shapeHeight 1.47))
	...
	(patternDef "CAPC2012X145N" (originalName "CAPC2012X145N")
		(multiLayer
			(pad (padNum 1) (padStyleRef r147_110) (pt -0.81, 0) (rotation 0))
			(pad (padNum 2) (padStyleRef r147_110) (pt 0.81, 0) (rotation 0))
		)
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 0, 0) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -1.51 0.89) (pt 1.51 0.89) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 1.51 0.89) (pt 1.51 -0.89) (width 0.05))
		)
	...
	(symbolDef "AS0805KKX7R0BB104" (originalName "AS0805KKX7R0BB104")
	...
	(compDef "AS0805KKX7R0BB104" (originalName "AS0805KKX7R0BB104") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "AS0805KKX7R0BB104"))
		...
		(attr "Manufacturer_Part_Number" "AS0805KKX7R0BB104")
		(attr "Mouser Part Number" "603-AS0805KKX70BB104")
		(attr "Mouser Price/Stock" "https://www.mouser.com/Search/Refine.aspx?Keyword=603-AS0805KKX70BB104")
		(attr "RS Part Number" "")
		(attr "RS Price/Stock" "")
		(attr "Description" "Multilayer Ceramic Capacitors MLCC - SMD/SMT 0.1uF 10% 100V AEC-Q200")
		(attr "<Hyperlink>" "https://mouser.componentsearchengine.com/Datasheets/1/AS0805KKX7R0BB104.pdf")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "AS0805KKX7R0BB104.stp")
