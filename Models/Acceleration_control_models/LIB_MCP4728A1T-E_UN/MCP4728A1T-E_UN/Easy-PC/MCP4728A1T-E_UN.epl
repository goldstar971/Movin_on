SamacSys ECAD Model
756547/124476/2.43/10/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "MCP4728A1T-E_UN" (originalName "MCP4728A1T-E_UN")
	...
	(compDef "MCP4728A1T-E_UN" (originalName "MCP4728A1T-E_UN") (compHeader (numPins 10) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "5" (pinName "RDY/__BSY") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "10" (pinName "VSS") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "9" (pinName "VOUTD") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "8" (pinName "VOUTC") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "7" (pinName "VOUTB") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "VOUTA") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MCP4728A1T-E_UN"))
		...
		(attr "Mouser Part Number" "579-MCP4728A1T-E/UN")
		(attr "Mouser Price/Stock" "https://www.mouser.com/Search/Refine.aspx?Keyword=579-MCP4728A1T-E%2FUN")
		(attr "Manufacturer_Name" "Microchip")
		(attr "Manufacturer_Part_Number" "MCP4728A1T-E/UN")
		(attr "Description" "Digital to Analog Converters - DAC Quad, 12-bit NV DAC with I2C interface")
		(attr "Datasheet Link" "https://componentsearchengine.com/Datasheets/1/MCP4728A1T-E_UN.pdf")
		(attr "Height" "1.1 mm")
	)
