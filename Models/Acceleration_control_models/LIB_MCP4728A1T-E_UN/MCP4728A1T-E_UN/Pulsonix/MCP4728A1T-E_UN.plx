...
(library Library_1
	...
	(compDef "MCP4728A1T-E_UN" (originalName "MCP4728A1T-E_UN") (compHeader (numPins 10) (numParts 1) (refDesPrefix IC)
		...
		(compPin "5" (pinName "RDY/__BSY") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "10" (pinName "VSS") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "9" (pinName "VOUTD") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "VOUTC") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "VOUTB") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "VOUTA") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/MCP4728A1T-E_UN.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "MCP4728A1T-E_UN.stp")
