...
//316235/124476/2.43/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "SN65HVD232DR" (originalName "SN65HVD232DR")
	...
	(compDef "SN65HVD232DR" (originalName "SN65HVD232DR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "4" (pinName "R") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SN65HVD232DR"))
		...
		(attr "Manufacturer_Part_Number" "SN65HVD232DR")
		(attr "Mouser Part Number" "595-SN65HVD232DR")
		(attr "Mouser Price/Stock" "https://www.mouser.com/Search/Refine.aspx?Keyword=595-SN65HVD232DR")
		(attr "RS Part Number" "")
		(attr "RS Price/Stock" "")
		(attr "Description" "3.3 V CAN Transceiver")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/sn65hvd232")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "SN65HVD232DR.stp")
