...
unsigned int LOCK_TIME = 4000; // This number is: 20,000 is 1 second.
unsigned int END_SPEED_RPM = 500; // Value in RPMs
...
short TempAng;
    ...
    if( uGF.bit.OpenLoop )
		...
		CtrlParm.qVelRef = ADCBUF3/10; // Initial Torque Reference
